...
for year in range(2016,2017):
    ...
    found_tracks[year]=tc_tracks(wind,mslp,sst,vort,ta,dates,year,tc_sel,working_dir=working_dir)
    found_tracks[year].set_thresholds(thr_wind=14,thr_vort=1*10**(-4),thr_mslp=101500,thr_ta=2,thr_sst=26,win1=3,win2=5,win3=7,neighborhood_size=4)
